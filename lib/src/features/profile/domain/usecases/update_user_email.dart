...
class UpdateUserEmailUseCase implements FirebaseUseCase<void, String> {
  final EditProfileRepo _editProfileRepo;

  const UpdateUserEmailUseCase(this._editProfileRepo);

  @override
  Future<FirebaseRequestResult<void>> call(String params) async {
    return await _editProfileRepo.updateUserEmail(params);
  }
}
