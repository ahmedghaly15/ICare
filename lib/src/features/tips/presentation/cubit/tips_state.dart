...
class TipsState<T> with _$TipsState<T> {
  ...
  const factory TipsState.convertBoolVal(bool boolean) = ConvertBoolVal<T>;
  ...
  const factory TipsState.updateRandomTipDialogOpacity(double opacity) =
      UpdateRandomTipDialogOpacity<T>;
}
