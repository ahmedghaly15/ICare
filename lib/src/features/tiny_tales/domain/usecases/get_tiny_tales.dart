...
class GetTinyTalesUseCase implements FirebaseUseCase<List<TinyTale>, NoParams> {
  final TinyTalesRepo _tinyTalesRepo;

  const GetTinyTalesUseCase(this._tinyTalesRepo);

  @override
  Future<FirebaseRequestResult<List<TinyTale>>> call(NoParams params) async {
    return await _tinyTalesRepo.getTinyTales();
  }
}
