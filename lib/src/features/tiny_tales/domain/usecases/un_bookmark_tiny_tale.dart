...
class UnBookmarkTinyTaleUseCase implements FirebaseUseCase<void, String> {
  final TinyTalesRepo _tinyTalesRepo;

  const UnBookmarkTinyTaleUseCase(this._tinyTalesRepo);

  @override
  Future<FirebaseRequestResult<void>> call(String params) async {
    return await _tinyTalesRepo.unBookmarkTinyTale(params);
  }
}
