...
class UnLikeTinyTaleUseCase implements FirebaseUseCase<void, String> {
  final TinyTalesRepo _tinyTalesRepo;

  const UnLikeTinyTaleUseCase(this._tinyTalesRepo);

  @override
  Future<FirebaseRequestResult<void>> call(String params) async {
    return await _tinyTalesRepo.unLikeTinyTale(params);
  }
}
