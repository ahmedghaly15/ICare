...
abstract class $LikeModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({ICareUser? user, String? dateTime});
...
class _$LikeModelImpl implements _LikeModel {
  const _$LikeModelImpl({this.user, this.dateTime});
  ...
  @override
  String toString() {
    return 'LikeModel(user: $user, dateTime: $dateTime)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, user, dateTime);
...
abstract class _LikeModel implements LikeModel {
  const factory _LikeModel({final ICareUser? user, final String? dateTime}) =
      _$LikeModelImpl;
