...
class LikeCommentReplyUseCase implements FirebaseUseCase<void, LikeParams> {
  final CommentRepliesRepo _commentRepliesRepo;

  const LikeCommentReplyUseCase(this._commentRepliesRepo);

  @override
  Future<FirebaseRequestResult<void>> call(LikeParams params) async {
    return await _commentRepliesRepo.likeCommentReply(params);
  }
}
