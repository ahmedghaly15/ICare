...
import 'package:icare/src/features/comments/presentation/cubit/comments_state.dart';
...
class CommentsCubit extends Cubit<CommentsState> {
  ...
  void typeNewComment(TypeNewCommentParams params) async {
  ...
  void uploadCommentImage(TypeNewCommentParams params) async {
