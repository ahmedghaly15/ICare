...
abstract class ChatRemoteDatasource {
  ...
  Future<List<void>> alsoDeleteChatForOtherUser(String receiverId);
...
class ChatRemoteDatasourceImpl implements ChatRemoteDatasource {
  ...
  Future<void> sendMessage(SendMessageParams params) async {
    final MessageModel message = MessageModel(
      ...
      senderName: Constants.currentUser!.name,
      messageData: params,
  ...
  @override
  Future<List<void>> alsoDeleteChatForOtherUser(String receiverId) async {
  ...
  Future<void> _deletingReceiverMessages(String receiverId) async {
    final receiverMessages =
        await _accessMessagesCollection(Constants.uId!, senderId: receiverId)
            .get();
    Future.forEach(
      receiverMessages.docs,
      (doc) async => await doc.reference.delete(),
    );
    await _accessChatsCollection(senderId: receiverId)
        .doc(Constants.uId)
        .delete();
  }
