...
class AlsoDeleteChatForOtherUserUseCase
    implements FirebaseUseCase<void, String> {
  final ChatRepo _chatRepo;

  const AlsoDeleteChatForOtherUserUseCase(this._chatRepo);

  @override
  Future<FirebaseRequestResult<void>> call(String params) async {
    return await _chatRepo.alsoDeleteChatForOtherUser(params);
  }
}
