...
class ChatState<T> with _$ChatState<T> {
  ...
  const factory ChatState.streamMessagesLoading() = StreamMessagesLoading;
  const factory ChatState.streamMessagesSuccess(List<MessageModel> messages) =
      StreamMessagesSuccess<T>;
  const factory ChatState.streamMessagesError(String error) =
      StreamMessagesError<T>;
