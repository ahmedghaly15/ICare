...
class SetupDIForUseCases {
  static void setup() {
    ...
    getIt.registerLazySingleton<AlsoDeleteChatForOtherUserUseCase>(
      () => AlsoDeleteChatForOtherUserUseCase(getIt.get<ChatRepo>()),
    );
    ...
    getIt.registerLazySingleton<DeleteNotificationUseCase>(
      () => DeleteNotificationUseCase(getIt.get<NotificationsRepo>()),
    );
  }
}
